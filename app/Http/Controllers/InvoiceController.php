...
class InvoiceController extends Controller
{
    ...
    public function receipt(Invoice $invoice)
    {
        ...
        $mPDF = new mPDF(array('utf-8', array(47, 1000), 5, 'freesans', 2, 2, 2, 0, 0, 0, 'P', 
        ...
        $p = 'P';
        $mPDF->_setPageSize(array(47, 1000), $p);
        $mPDF->WriteHTML($html);
        $pageHeight = $mPDF->y + 5;
        // dd($pageHeight);
        $mPDF->page   = 0;
        ...
        $newPDF = new mPDF(array('utf-8', array(47, 1000), 5, 'freesans', 2, 2, 2, 0, 0, 0, 'P', 
                        "fontDir" => array_merge($fontDirs, [storage_path('fonts/')]),
                        "fontdata" => $fontData + [
                            'monaco' => [
                                'R' => 'monaco.ttf'
                        ...
                        'defaul_font' => 'monaco' ));
        $newPDF->_setPageSize(array(47, $pageHeight), $p);
