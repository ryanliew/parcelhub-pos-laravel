@if(auth()->check())
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('members.page') }}">Member list</a></li>
...
{{-- 
        ...
        <li class="nav-item"><a class="nav-link" href="/members/inactive">Approve member</a></li>
